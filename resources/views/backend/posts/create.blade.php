...
<div class="px-4 mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
    ...
    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-6">
            <label for="title" class="block mb-1 text-lg font-medium text-gray-800 dark:text-gray-100">Title</label>
            <input type="text" id="title" name="title" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" required>
        </div>
        
         </div>
            <div class="mb-6">
            <label for="author" class="block mb-1 text-lg font-medium text-gray-800 dark:text-gray-100">Author</label>
            <input type="text" id="author" name="author" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" value="{{ $user->name }}" readonly required>
            <input type="hidden" name="user_id" value="{{ $user->id }}">
        </div>

        <div class="grid grid-cols-2 gap-4 mb-4">
            <div class="col-span-2 mb-6 sm:col-span-1">
                <label for="category" class="block mb-1 text-lg font-medium text-gray-800 dark:text-gray-100">Category</label>
                <select id="category" name="category_id" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" required>
            ...
            <div class="col-span-2 mb-6 sm:col-span-1">
                <label for="tags" class="block mb-1 text-lg font-medium text-gray-800 dark:text-gray-100">Tags</label>
                <div class="relative">
                            ...
                            @foreach($tags as $tag)
                                <li>
                                    <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                        <input id="tag_{{ $tag->id }}" type="checkbox" name="tags[]" value="{{ $tag->id }}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
        ...
        <div class="mb-6">
            ...
            <textarea id="content" name="content" class="w-full px-4 py-2 border border-gray-300 rounded-md dark:border-gray-700 focus:outline-none focus:border-indigo-500" rows="6" required></textarea>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center justify-center w-9/12 mx-auto">
                <label for="dropzone" id="dropzone-label" class="relative flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                    <div id="preview-container" class="flex flex-wrap justify-center mt-4"></div>
                    <div id="instructions" class="flex flex-col items-center justify-center pt-5 pb-6">
        ...
        <div class="flex justify-end">
            <button type="submit" class="px-6 py-2 font-semibold text-white bg-indigo-500 rounded-md hover:bg-indigo-600 focus:outline-none">Submit</button>
        </div>
    </form>
</div>
