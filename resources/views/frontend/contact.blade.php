...
@section('content')
  ...
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <form  class="space-y-8" method="POST" action="https://script.google.com/macros/s/AKfycbxRKiTTDpa4HNfdTVvLQ2DtQmOF7tzjFhDwdwjdvtCBV9uoh9PzJSZeb4gMg3Io1wYU/exec" id="my-form">
          <div>
